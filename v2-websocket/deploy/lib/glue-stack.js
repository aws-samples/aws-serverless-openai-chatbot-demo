    ...
    constructor(scope, id, props) {
      ...
      const job = new glue.Job(this, 'chatbot-from-s3-to-aos',{
          ...
          defaultArguments:{
              ...
              '--region':props.region,
              '--embedding_endpoint_all_minilm':process.env.embedding_endpoint_all_minilm,
              '--embedding_endpoint_paraphrase':process.env.embedding_endpoint_paraphrase,
              '--UPLOADS_BUCKET':process.env.UPLOADS_BUCKET,
              '--llm_endpoint':process.env.llm_endpoint,
              '--DOC_INDEX_TABLE':props.table,
              '--OPENAI_API_KEY': process.env.OPENAI_API_KEY,
              '--additional-python-modules':'awswrangler==3.1.1,gremlinpython==3.6.3,langchain==0.0.157,opensearch-py==2.2.0,tiktoken==0.3.3,PyPDF2==3.0.1',
